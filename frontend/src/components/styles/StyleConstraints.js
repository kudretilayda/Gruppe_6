...
const StyleConstraints = () => {
  ...
  // Bewertungsfunktion für OutfitPlaner basierend auf den Constraints
  const evaluateOutfit = (outfit) => {
    ...
    return score; // Gibt die Punktzahl des OutfitPlaner zurück
  };

  // Funktion zum Hinzufügen eines OutfitPlaner
  ...
  return (
    <div>
      ...
      {/* Beispiel eines OutfitPlaner hinzufügen */}
